  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        {!logged && <Stack.Screen name="LandPage" component={LandPage} />}
        {!logged && <Stack.Screen name="SignIn" component={SignIn} />}
        {!logged && <Stack.Screen name="Register" component={Register} />}
        <Stack.Screen name="Home">
          {(props) => <Home {...props} logged={logged} setLogged={setLogged} />}
        </Stack.Screen>
